...
<html>
	<head>
		...
		<link
			rel="stylesheet"
			type="text/css"
			href="{{ url('resources/assets/admin/src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}"
		/>
		<link
			rel="stylesheet"
			type="text/css"
			href="{{ url('resources/assets/admin/src/plugins/datatables/css/responsive.bootstrap4.min.css') }}"
		/>
	...
	<body>
			...
			<div class="header-right">
				...
				<div class="github-link">
					<a href="https://github.com/dropways/deskapp" target="_blank"
						><img src="{{ url('resources/assets/admin/vendors/images/github.svg') }}" alt=""
					/></a>
				</div>
			</div>
		</div>
					...
					<ul id="accordion-menu">
						...
						<li>
							...
							>
								...
								<span class="mtext"
									>Landing Page
									<img src="{{ url('resources/assets/admin/vendors/images/coming-soon.png') }}" alt="" width="25"
								/></span>
							</a>
						</li>
					</ul>
								...
								<ul>
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{ url('resources/assets/admin/vendors/images/photo1.jpg') }}"
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{ url('resources/assets/admin/vendors/images/photo2.jpg') }}"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{ url('resources/assets/admin/vendors/images/photo3.jpg') }}"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{ url('resources/assets/admin/vendors/images/photo4.jpg') }}"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
					...
					<div class="col-lg-4 col-md-12 mb-20">
						<div class="card-box height-100-p pd-20 min-height-200px">
							<div class="max-width-300 mx-auto">
								<img src="{{ url('resources/assets/admin/vendors/images/upgrade.svg') }}" alt="" />
							</div>
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{ url('resources/assets/admin/vendors/images/photo5.jpg') }}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{ url('resources/assets/admin/vendors/images/photo6.jpg') }}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{ url('resources/assets/admin/vendors/images/photo9.jpg') }}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{ url('resources/assets/admin/vendors/images/photo8.jpg') }}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
				...
				<div class="row">
					<div class="col-md-4 mb-20">
						<a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
							<div class="img pb-30">
								<img src="{{ url('resources/assets/admin/vendors/images/medicine-bro.svg') }}" alt="" />
							</div>
							<div class="content">
					...
					<div class="col-md-4 mb-20">
						<a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
							<div class="img pb-30">
								<img src="{{ url('resources/assets/admin/vendors/images/remedy-amico.svg') }}" alt="" />
							</div>
							<div class="content">
					...
					<div class="col-md-4 mb-20">
						<a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
							<div class="img pb-30">
								<img src="{{ url('resources/assets/admin/vendors/images/paper-map-cuate.svg') }}" alt="" />
							</div>
							<div class="content">
		...
		<script src="{{ url('resources/assets/admin/vendors/scripts/dashboard3.js') }}"></script>
